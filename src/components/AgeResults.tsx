...
const resultsTranslations = {
  cs: {
    yourAge: '📊 Váš věk',
    years: 'let', months: 'měsíců', weeks: 'týdnů', days: 'dní', hours: 'hodin', minutes: 'minut', seconds: 'sekund',
    basicUnits: '📅 Základní jednotky', biologicalUnits: '🫀 Biologické jednotky', cosmicUnits: '🌌 Kosmické jednotky', culturalUnits: '🎭 Kulturní jednotky', funUnits: '🎉 Zábavné jednotky',
    fromTo: 'Od {from} do {to}'
  },
  en: {
    yourAge: '📊 Your age',
    years: 'years', months: 'months', weeks: 'weeks', days: 'days', hours: 'hours', minutes: 'minutes', seconds: 'seconds',
    basicUnits: '📅 Basic units', biologicalUnits: '🫀 Biological units', cosmicUnits: '🌌 Cosmic units', culturalUnits: '🎭 Cultural units', funUnits: '🎉 Fun units',
    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-xl p-6 border border-blue-200 dark:border-blue-800">
        ...
        <div className="mt-6 text-center text-sm text-gray-600 dark:text-gray-400">
          <p>{t.fromTo.replace('{from}', formatDate(birthDate, locale)).replace('{to}', formatDate(currentDate, locale))}</p>
        </div>
      </div>
